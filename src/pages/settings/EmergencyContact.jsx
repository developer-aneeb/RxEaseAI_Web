...
export default function EmergencyContactSection({ emergencyContacts, onSaveSuccess }) {
  ...
  return (
    <Card id="emergency-card" variant="glass" className="p-6 bg-white/70 dark:bg-slate-900/80 text-left border border-slate-200 dark:border-slate-800 shadow-md relative">
      ...
      {showAddForm && (
        <div id="contact-form-anchor" className="border-t border-slate-100 dark:border-slate-800 pt-5 space-y-4 mb-6 animate-fade-in">
      ...
      {/* Floating Add Button (when form is hidden and no contacts or user wants to see it) */}
      {!showAddForm && activeContacts.length === 0 && (
