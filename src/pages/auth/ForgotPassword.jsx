...
export default function ForgotPassword() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const friendlyMsg = getFriendlyErrorMessage(error, 'Failed to send password reset email.');
              ...
              {isSuccess ? (
                <div className="flex flex-col items-center justify-center py-10 text-center relative z-10 animate-fade-in-up">
                  ...
                  <p className="font-body-md text-body-md text-on-surface-variant dark:text-slate-400 max-w-[320px] mb-8">
                    We've sent a secure password reset link to <span className="font-semibold text-on-surface dark:text-white">{resetEmail}</span>.
                  </p>
