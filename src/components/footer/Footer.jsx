      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-5 text-left space-y-4">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 max-w-sm font-light leading-relaxed">
              Automating clinical prescription ingestion with cutting-edge OCR line segmentation and dosage verification systems.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3 pt-2">
              <a href="#" aria-label="Twitter" className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-900 hover:bg-indigo-600 text-slate-500 dark:text-slate-400 hover:text-white flex items-center justify-center transition-colors shadow-xs">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/>
                </svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-900 hover:bg-indigo-600 text-slate-500 dark:text-slate-400 hover:text-white flex items-center justify-center transition-colors shadow-xs">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="#" aria-label="GitHub" className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-900 hover:bg-indigo-600 text-slate-500 dark:text-slate-400 hover:text-white flex items-center justify-center transition-colors shadow-xs">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="md:col-span-4 text-left space-y-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 rounded-xl px-3 py-2 text-xs text-slate-800 dark:text-slate-350 focus:outline-none focus:border-indigo-500/60 transition-colors duration-300"
              />
              <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-semibold transition-colors shadow-md shadow-indigo-600/10">
                Join
              </button>
            </div>
          </div>
